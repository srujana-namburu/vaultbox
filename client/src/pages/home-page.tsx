    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pb-16 lg:pb-0">
        ...
        <div className="p-4 lg:p-8">
          ...
          <div className="mb-8 bg-primary/40 rounded-xl p-6 shadow-neumorphic">
            <div className="flex flex-col lg:flex-row lg:items-center">
              ...
              <div className="mt-4 lg:mt-0 lg:ml-6 flex flex-col lg:items-end">
                <Link href="/security-recommendations">
                  <Button variant="link" className="text-secondary hover:text-white transition-colors p-0">
